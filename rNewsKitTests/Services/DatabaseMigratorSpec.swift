...
class DatabaseMigratorSpec: QuickSpec {
    override func spec() {
        ...
        describe("migrating from one database to another") {
            ...
            let oldArticle1 = Article(title: "oldarticle1", link: NSURL(string: "https://example.com/feed1/1"), summary: "old1Summary", authors: [Author("me1")], published: NSDate(timeIntervalSince1970: 1), updatedAt: nil, identifier: "ident1", content: oldContent, read: true, estimatedReadingTime: 0, feed: oldFeed1, flags: ["hello", "there"], enclosures: [])
            ...
            let oldArticle2 = Article(title: "oldarticle2", link: NSURL(string: "https://example.com/feed2/2"), summary: "old2summary", authors: [Author("me2")], published: NSDate(timeIntervalSince1970: 1), updatedAt: nil, identifier: "ident2", content: "content2", read: true, estimatedReadingTime: 20, feed: oldFeed2, flags: ["hello", "there"], enclosures: [])
            ...
            describe("migrating articles") {
                it("migrates every article over") {
                    let changedArticle = Article(title: "oldarticle1", link: NSURL(string: "https://example.com/feed1/1"), summary: "old1Summary", authors: [Author("me1")], published: NSDate(timeIntervalSince1970: 1), updatedAt: nil, identifier: "ident1", content: oldContent, read: true, estimatedReadingTime: 2, feed: oldFeed1, flags: ["hello", "there"], enclosures: [])
