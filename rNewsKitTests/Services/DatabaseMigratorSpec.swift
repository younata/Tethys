        ...
        describe("migrating from one database to another") {
            ...
            describe("migrating articles") {
                it("migrates every article over") {
                    let changedArticle = Article(title: "oldarticle1", link: NSURL(string: "https://example.com/feed1/1"), summary: "old1Summary", authors: [Author("me1")], published: NSDate(timeIntervalSince1970: 1), updatedAt: nil, identifier: "ident1", content: oldContent, read: true, estimatedReadingTime: 2, feed: oldFeed1, flags: ["hello", "there"])
