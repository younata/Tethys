        ...
        describe("updating feeds") {
            ...
            context("when the feeds list comes back and new articles are found") {
                ...
                beforeEach {
                    ...
                    let article1 = Article(title: "a", link: URL(string: "https://exapmle.com/1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "a", content: "", read: false, estimatedReadingTime: 0, feed: feed1, flags: [])
                    let article2 = Article(title: "b", link: URL(string: "https://exapmle.com/1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "b", content: "", read: false, estimatedReadingTime: 0, feed: feed1, flags: [])
                    let article3 = Article(title: "c", link: URL(string: "https://exapmle.com/1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "c", content: "", read: false, estimatedReadingTime: 0, feed: feed2, flags: [])
                    let article4 = Article(title: "d", link: URL(string: "https://exapmle.com/1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "d", content: "", read: false, estimatedReadingTime: 0, feed: feed2, flags: [])
