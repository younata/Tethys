...
class UIApplicationRNewsSpec: QuickSpec {
    override func spec() {
        ...
        it("does nothing to the badge number if a read article is deleted") {
            let article = Article(title: "", link: URL(string: "https://exapmle.com/1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "", content: "", read: true, synced: false, estimatedReadingTime: 0, feed: nil, flags: [])
            subject.deletedArticle(article)
