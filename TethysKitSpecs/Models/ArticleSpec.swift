...
class ArticleSpec: QuickSpec {
    override func spec() {
        ...
        beforeEach {
            ...
            subject = Article(title: "", link: URL(string: "https://example.com/article1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "", content: "", read: false, synced: false, estimatedReadingTime: 0, feed: nil, flags: [])
        }
        ...
        describe("Equatable") {
            ...
            it("should report two articles not created with datastore objects with the same property equality as equal") {
                let date = Date()
                let a = Article(title: "", link: URL(string: "https://example.com/articlea")!, summary: "", authors: [], published: date, updatedAt: nil, identifier: "", content: "", read: false, synced: false, estimatedReadingTime: 0, feed: nil, flags: [])
                let b = Article(title: "blah", link: URL(string: "https://example.com")!, summary: "hello", authors: [Author("anAuthor")], published: Date(timeIntervalSince1970: 0), updatedAt: nil, identifier: "hi", content: "hello there", read: true, synced: false, estimatedReadingTime: 70, feed: nil, flags: ["flag"])
                let c = Article(title: "", link: URL(string: "https://example.com/articlea")!, summary: "", authors: [], published: date, updatedAt: nil, identifier: "", content: "", read: false, synced: false, estimatedReadingTime: 0, feed: nil, flags: [])
        ...
        describe("Hashable") {
            ...
            it("should report two articles not created from datastores with the same property equality as having the same hashValue") {
                let date = Date()
                let a = Article(title: "", link: URL(string: "https://example.com/article1")!, summary: "", authors: [], published: date, updatedAt: nil, identifier: "", content: "", read: false, synced: false, estimatedReadingTime: 0, feed: nil, flags: [])
                let b = Article(title: "blah", link: URL(string: "https://example.com")!, summary: "hello", authors: [Author("anAuthor")], published: Date(timeIntervalSince1970: 0), updatedAt: nil, identifier: "hi", content: "hello there", read: true, synced: false, estimatedReadingTime: 60, feed: nil, flags: ["flag"])
                let c = Article(title: "", link: URL(string: "https://example.com/article1")!, summary: "", authors: [], published: date, updatedAt: nil, identifier: "", content: "", read: false, synced: false, estimatedReadingTime: 0, feed: nil, flags: [])
        ...
        describe("adding a flag") {
            ...
            context("trying to add the same flag again") {
                beforeEach {
                    subject = Article(title: "", link: URL(string: "https://example.com/article1")!, summary: "", authors: [], published: Date(), updatedAt: nil, identifier: "", content: "", read: false, synced: false, estimatedReadingTime: 0, feed: nil, flags: ["flag"])
                }
