...
class UIApplicationRNewsSpec: QuickSpec {
    override func spec() {
        ...
        it("does nothing to the badge number if a read article is deleted") {
            let article = Article(title: "", link: nil, summary: "", author: "", published: NSDate(), updatedAt: nil, identifier: "", content: "", read: true, estimatedReadingTime: 0, feed: nil, flags: [], enclosures: [])
            subject.deletedArticle(article)
