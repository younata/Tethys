    ...
    override func spec() {
        ...
        describe("setting an accountType") {
            describe("to .Pasiphae") {
                ...
                it("sets the view title to 'Tethys Backend'") {
                    expect(subject.title) == "Tethys Backend"
                }

                it("sets the title label to 'Log in to Tethys'") {
                    expect(subject.titleLabel.text) == "Log in to Tethys"
                }
        ...
        describe("logging in") {
            ...
            describe("entering both") {
                ...
                describe("tapping the login button") {
                    var loginPromise: Promise<Result<Void, TethysError>>!

                    beforeEach {
                        loginPromise = Promise<Result<Void, TethysError>>()
                ...
                describe("tapping the register button") {
                    var registerPromise: Promise<Result<Void, TethysError>>!

                    beforeEach {
                        registerPromise = Promise<Result<Void, TethysError>>()
