...
@property (nonatomic, copy) void (^ _Nonnull onFailure)(NSError * _Nonnull);
- (FeedParser * _Nonnull)failure:(void (^ _Nonnull)(NSError * _Nonnull))failed;
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull currentPath;
@property (nonatomic) BOOL parseStructureAsContent;
@property (nonatomic, copy) NSDictionary * _Nonnull lastAttributes;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull atomArticleContent;
@property (nonatomic, copy) NSArray<NSString *> * _Nullable atomXHTMLPath;
...
- (void)parser:(NSXMLParser * _Nonnull)parser foundIgnorableWhitespace:(NSString * _Nonnull)whitespaceString;
