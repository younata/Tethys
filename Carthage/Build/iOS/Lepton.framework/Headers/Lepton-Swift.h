...
@property (nonatomic, copy) NSString * _Nullable xmlURL;
...
@property (nonatomic, copy) void (^ _Nonnull callback)(NSArray<Item *> * _Nonnull);
@property (nonatomic, copy) void (^ _Nonnull onFailure)(NSError * _Nonnull);
- (Parser * _Nonnull)success:(void (^ _Nonnull)(NSArray<Item *> * _Nonnull))onSuccess;
- (Parser * _Nonnull)failure:(void (^ _Nonnull)(NSError * _Nonnull))failed;
- (nonnull instancetype)initWithText:(NSString * _Nonnull)text OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)configureWithText:(NSString * _Nonnull)text;
- (void)main;
- (void)cancel;
